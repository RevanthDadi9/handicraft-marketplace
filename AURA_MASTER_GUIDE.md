# 🧶 AuraCraft: System Operations & Master Guide

Welcome to the modernized **AuraCraft** marketplace. This document provides a comprehensive overview of how the system operates, the technical architecture, and instructions for running the platform.

---

## 🏛️ System Architecture

AuraCraft uses a **Modular Hexagonal-Lite Architecture**, separating concerns into three distinct layers to ensure scalability and maintainability.
...
## 🎨 Design Philosophy: "AuraCraft Luxury"
